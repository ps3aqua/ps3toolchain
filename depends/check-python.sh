...
( ls -1d "${pyprefix}"/include/python3.*/Python.h || ls -1d /opt/local/include/python3.*/Python.h ) 1>/dev/null 2>&1 || [ -f "$PYINSTALLDIR/include/Python.h" ] || { echo "ERROR: Install python-dev before continuing."; exit 1; }
